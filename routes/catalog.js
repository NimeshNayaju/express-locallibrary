...
var book_instance_controller = require('../controllers/book_instanceController');
...
router.get('/book/create', book_controller.book_create_get); // should come before routes that display BOok (uses id)
